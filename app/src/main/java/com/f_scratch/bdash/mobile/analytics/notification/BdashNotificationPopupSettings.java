...
public class BdashNotificationPopupSettings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //割り込み通知音の設定
        ((CheckBox) findViewById(R.id.com_f_scratch_bdash_mobile_check_sound)).setChecked(BDashNotification.getInstance(getApplicationContext()).isEnablePopupSound());
        ((CheckBox) findViewById(R.id.com_f_scratch_bdash_mobile_check_sound)).setOnClickListener(new View.OnClickListener(){
            @Override
        ...
        //割り込み通知のバイブレーション設定
        ((CheckBox) findViewById(R.id.com_f_scratch_bdash_mobile_check_vib)).setChecked(BDashNotification.getInstance(getApplicationContext()).isEnablePopupVibration());
        ((CheckBox) findViewById(R.id.com_f_scratch_bdash_mobile_check_vib)).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                boolean isChecked = ((CheckBox)view).isChecked();
                try {
