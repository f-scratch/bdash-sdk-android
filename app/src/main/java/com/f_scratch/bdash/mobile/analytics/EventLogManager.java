...
class EventLogManager {
    ...
    public synchronized void load(){
        try {
            // イベントバッファを読み込む
            ArrayList<HashMap<String,Object>> results = (ArrayList<HashMap<String,Object>>) StorageUtil.deserialize((StorageUtil.FileType.EVENT_LOGS));
            if( results != null ) {
                eventLogs = results;
            }

            // 一時バッファを読み込む
            ArrayList<HashMap<String, Object>> workResults = (ArrayList<HashMap<String, Object>>) StorageUtil.deserialize((StorageUtil.FileType.EVENT_WORK_LOGS));
            if (workResults != null) {
